...
def blogger_register():
    quote = get_quote()
    form = BloggerrRegistrationForm()
    if form.validate_on_submit():
        blogger = Writer(blogger_email = form.blogger_email.data, blogger_name = form.blogger_name.data,password = form.writer_password.data)
